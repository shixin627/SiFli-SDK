...
void tcpclient(int argc, char **argv)
{
    ...
    server_addr.sin_addr.s_addr = ip4_addr_get_u32(&target_addr);
    ...
    //配置心跳检测参数   默认参数时间很长
    setsockopt(sock, IPPROTO_TCP, TCP_KEEPIDLE, &tcp_keepalive_idle, sizeof(int));
    setsockopt(sock, IPPROTO_TCP, TCP_KEEPINTVL, &tcp_keepalive_intvl, sizeof(int));
    setsockopt(sock, IPPROTO_TCP, TCP_KEEPCNT, &tcp_keepalive_cnt, sizeof(int));
