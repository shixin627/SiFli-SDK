...
#endif /* BSP_PWMT2_UPDATE_USING_DMA */
...
#define PWMT2_CC3_DMA_CONFIG                                                   \
{                                                                              \
   .dma_handle.Init.Priority            = PWMT2_CC3_DMA_IRQ_PRIO,              \
   .dma_handle.Instance                 = PWMT2_CC3_DMA_INSTANCE,              \
   .dma_handle.Init.Request             = PWMT2_CC3_DMA_REQUEST,               \
   .dma_irq                             = PWMT2_CC3_DMA_IRQ,                   \
   .dma_handle_index                    = GPT_DMA_ID_CC3,                      \
   .dma_handle.Init.PeriphDataAlignment = PWMT2_CC3_DMA_PDATAALIGN,            \
   .dma_handle.Init.MemDataAlignment    = PWMT2_CC3_DMA_MDATAALIGN             \
}
#endif /* BSP_PWMT2_CC3_USING_DMA */

#ifdef BSP_PWMT2_CC4_USING_DMA
#define PWMT2_CC4_DMA_CONFIG                                                   \
{                                                                              \
   .dma_handle.Init.Priority            = PWMT2_CC4_DMA_IRQ_PRIO,              \
   .dma_handle.Instance                 = PWMT2_CC4_DMA_INSTANCE,              \
   .dma_handle.Init.Request             = PWMT2_CC4_DMA_REQUEST,               \
   .dma_irq                             = PWMT2_CC4_DMA_IRQ,                   \
   .dma_handle_index                    = GPT_DMA_ID_CC4,                      \
   .dma_handle.Init.PeriphDataAlignment = PWMT2_CC4_DMA_PDATAALIGN,            \
   .dma_handle.Init.MemDataAlignment    = PWMT2_CC4_DMA_MDATAALIGN             \
}
#endif /* BSP_PWMT2_CC4_USING_DMA */
...
#define PWMT5_CC1_DMA_CONFIG                                                   \
{                                                                              \
   .dma_handle.Init.Priority            = PWMT5_CC1_DMA_IRQ_PRIO,              \
   .dma_handle.Instance                 = PWMT5_CC1_DMA_INSTANCE,              \
   .dma_handle.Init.Request             = PWMT5_CC1_DMA_REQUEST,               \
   .dma_irq                             = PWMT5_CC1_DMA_IRQ,                   \
   .dma_handle_index                    = GPT_DMA_ID_CC1,                      \
   .dma_handle.Init.PeriphDataAlignment = PWMT5_CC1_DMA_PDATAALIGN,            \
   .dma_handle.Init.MemDataAlignment    = PWMT5_CC1_DMA_MDATAALIGN             \
}
#endif /* BSP_PWMT5_CC1_USING_DMA */

#ifdef BSP_PWMT5_CC2_USING_DMA
#define PWMT5_CC2_DMA_CONFIG                                                   \
{                                                                              \
   .dma_handle.Init.Priority            = PWMT5_CC2_DMA_IRQ_PRIO,              \
   .dma_handle.Instance                 = PWMT5_CC2_DMA_INSTANCE,              \
   .dma_handle.Init.Request             = PWMT5_CC2_DMA_REQUEST,               \
   .dma_irq                             = PWMT5_CC2_DMA_IRQ,                   \
   .dma_handle_index                    = GPT_DMA_ID_CC2,                      \
   .dma_handle.Init.PeriphDataAlignment = PWMT5_CC2_DMA_PDATAALIGN,            \
   .dma_handle.Init.MemDataAlignment    = PWMT5_CC2_DMA_MDATAALIGN             \
}
#endif /* BSP_PWMT5_CC2_USING_DMA */

#ifdef BSP_PWMT5_CC3_USING_DMA
#define PWMT5_CC3_DMA_CONFIG                                                   \
{                                                                              \
   .dma_handle.Init.Priority            = PWMT5_CC3_DMA_IRQ_PRIO,              \
   .dma_handle.Instance                 = PWMT5_CC3_DMA_INSTANCE,              \
   .dma_handle.Init.Request             = PWMT5_CC3_DMA_REQUEST,               \
   .dma_irq                             = PWMT5_CC3_DMA_IRQ,                   \
   .dma_handle_index                    = GPT_DMA_ID_CC3,                      \
   .dma_handle.Init.PeriphDataAlignment = PWMT5_CC3_DMA_PDATAALIGN,            \
   .dma_handle.Init.MemDataAlignment    = PWMT5_CC3_DMA_MDATAALIGN             \
}
#endif /* BSP_PWMT5_CC3_USING_DMA */

#ifdef BSP_PWMT5_CC4_USING_DMA
#define PWMT5_CC4_DMA_CONFIG                                                   \
{                                                                              \
   .dma_handle.Init.Priority            = PWMT5_CC4_DMA_IRQ_PRIO,              \
   .dma_handle.Instance                 = PWMT5_CC4_DMA_INSTANCE,              \
   .dma_handle.Init.Request             = PWMT5_CC4_DMA_REQUEST,               \
   .dma_irq                             = PWMT5_CC4_DMA_IRQ,                   \
   .dma_handle_index                    = GPT_DMA_ID_CC4,                      \
   .dma_handle.Init.PeriphDataAlignment = PWMT5_CC4_DMA_PDATAALIGN,            \
   .dma_handle.Init.MemDataAlignment    = PWMT5_CC4_DMA_MDATAALIGN             \
}
#endif /* BSP_PWMT5_CC4_USING_DMA */
...
{                                                                              \
   ...
   .dma_handle.Init.Request             = PWMA1_UPDATE_DMA_REQUEST,            \
