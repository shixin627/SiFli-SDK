...
#define LCD_BOARD_POWER_PIN     (57)      // GPIO_A57
//#define QSPI2_CLK_PIN           (60)      // GPIO_A60
#define LCD_RESET_PIN           (17)      // GPIO_B17

#define DSI_TP_RESET_PIN            (41)       // GPIO_A41
#define QSPI_TP_RESET_PIN              (28)    // GPIO_A28
#define LCPU_QSPI_TP_RESET_PIN         (29)
...
void BSP_TP_PowerUp(void)
{
    ...
    BSP_GPIO_Set(DSI_TP_RESET_PIN, 1, 1);  //TP_RST
#else
    BSP_GPIO_Set(DSI_TP_RESET_PIN, 1, 1);  //TP_RST
    BSP_GPIO_Set(QSPI_TP_RESET_PIN, 1, 1);
    BSP_GPIO_Set(LCPU_QSPI_TP_RESET_PIN, 1, 1);
#endif
...
void BSP_TP_PowerDown(void)
{
    ...
    //BSP_GPIO_Set(DSI_TP_RESET_PIN, 0, 1);
#if 0
    HAL_GPIO_DeInit(hwp_gpio1, DSI_TP_RESET_PIN);
    HAL_PIN_Set(PAD_PA00, GPIO_A0, PIN_NOPULL, 1);
    HAL_PIN_SetMode(PAD_PA00, 1, PIN_ANALOG_INPUT);
#else
    BSP_GPIO_Set(DSI_TP_RESET_PIN, 0, 1);
    BSP_GPIO_Set(QSPI_TP_RESET_PIN, 0, 1);
    BSP_GPIO_Set(LCPU_QSPI_TP_RESET_PIN, 0, 1);
...
{
    BSP_GPIO_Set(DSI_TP_RESET_PIN, high1_low0, 1);
    BSP_GPIO_Set(QSPI_TP_RESET_PIN, high1_low0, 1);
    BSP_GPIO_Set(LCPU_QSPI_TP_RESET_PIN, high1_low0, 1);
