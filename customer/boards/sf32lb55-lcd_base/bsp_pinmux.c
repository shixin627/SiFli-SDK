...
void BSP_PIN_Init(void)
{
    ...
    HAL_PIN_Set(PAD_PA20, LCDC1_SPI_CLK, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA31, LCDC1_SPI_CS, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA34, LCDC1_SPI_DIO0, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA36, LCDC1_SPI_DIO1, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA38, LCDC1_SPI_DIO2, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA42, LCDC1_SPI_DIO3, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA35, LCDC1_SPI_TE, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA37, GPIO_A37, PIN_NOPULL, 1); //LCD rst
#elif defined (LCD_USING_MULT_LCD_MODULE)
    HAL_PIN_Set(PAD_PA20, LCDC1_SPI_CLK, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA31, LCDC1_SPI_CS, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA34, LCDC1_SPI_DIO0, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA36, LCDC1_SPI_DIO1, PIN_PULLUP, 1);
    ...
    HAL_PIN_Set(PAD_PB32, LCDC2_SPI_CLK, PIN_PULLUP, 0);
    HAL_PIN_Set(PAD_PB33, LCDC2_SPI_CS, PIN_PULLUP, 0);
    HAL_PIN_Set(PAD_PB35, LCDC2_SPI_DIO0, PIN_PULLUP, 0);
    HAL_PIN_Set(PAD_PB36, LCDC2_SPI_DIO1, PIN_PULLUP, 0);
    HAL_PIN_Set(PAD_PB37, LCDC2_SPI_DIO2, PIN_PULLUP, 0);
    HAL_PIN_Set(PAD_PB07, LCDC2_SPI_DIO3, PIN_PULLUP, 0);
    HAL_PIN_Set(PAD_PB18, LCDC2_SPI_TE, PIN_PULLUP, 0);
    HAL_PIN_Set(PAD_PB17, GPIO_B17, PIN_NOPULL, 0); //LCD rst

#endif

//key
    HAL_PIN_Set(PAD_PB47, GPIO_B47, PIN_NOPULL, 0);             // KEY1
    HAL_PIN_Set(PAD_PB48, GPIO_B48, PIN_NOPULL, 0);             // KEY2
//rgbled
    ...
    HAL_PIN_Set(PAD_PA50, GPIO_A50, PIN_NOPULL, 1);             // MIC_EN
#endif
