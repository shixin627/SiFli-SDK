...
{ \
    ...
    {FAL_PART_MAGIC_WORD,       "prefdb",     NOR_FLASH3_DEV_NAME,    KVDB_PREFDB_REGION_OFFSET,  KVDB_PREFDB_REGION_SIZE, 0}, \
    {FAL_PART_MAGIC_WORD,       "download",     NOR_FLASH3_DEV_NAME,    BLE_OTA_REGION_OFFSET,  BLE_OTA_REGION_SIZE, 0}, \
}
