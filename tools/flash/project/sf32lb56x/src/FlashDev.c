...
#ifdef JLINK_FLASH_1
    #define FLASH_NAME  "SF32LB56X Internal Flash1"
    #define FLASH_BASE  0x10000000
    #define FLASH_SIZE  0x00400000
#elif defined(JLINK_FLASH_2)
    #define FLASH_NAME  "SF32LB56X External Flash2"
    #define FLASH_BASE  0x10400000
    #define FLASH_SIZE  0x03C00000
#elif defined(JLINK_FLASH_3)
    #define FLASH_NAME  "SF32LB56X External Flash3"
    #define FLASH_BASE  0x14000000
    #define FLASH_SIZE  0x0C000000
#elif defined(JLINK_FLASH_5)
    #define FLASH_NAME  "SF32LB56X External Flash5"
...
{
    ALGO_VERSION,              // Algo version
    "SF32LB56X UNI_FLASH",    // Flash device name
    ONCHIP,                    // Flash device type
