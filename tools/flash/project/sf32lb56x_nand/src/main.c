...
static void JLINK_DRV_BSP_PIN_Init(void)
{
    ...
    HAL_PIN_Set(PAD_PA72, GPIO_A72, PIN_PULLUP, 1);      
    HAL_PIN_Set(PAD_PA74, GPIO_A74, PIN_PULLUP, 1);      
...
#endif
    HAL_PIN_Set(PAD_PA18, GPIO_A18, PIN_PULLDOWN, 1); //MEM_POWE_PIN for Weike
