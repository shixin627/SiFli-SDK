...
uint32_t sd_send_cmd(uint8_t cmd_idx,uint32_t cmd_arg)
{
  ...
  switch (cmd_idx) {
    case  0:
    case  4:
    case 15: resp_type = RESP_NONE; break;
    case  2:
    case  9:
    case 10: resp_type = RESP_R2; break;
    case 41: resp_type = RESP_R3; break; //ACMD41
    case  3: resp_type = RESP_R6; break;
    case  8: resp_type = RESP_R7; break;
    case  6:
    case  7: resp_type = RESP_R1b;break;
    default: resp_type = RESP_R1; break;
  }
  ...
  switch (cmd_idx) {
    ...
    case 21:
    case 17:
    case 18: with_data = 1; break;
    default: with_data = 0; break;
  }
  switch (resp_type) {
    case RESP_NONE: cmd_para = SDHCI_CMD_RESP_NONE; break;
    case RESP_R2:   cmd_para = SDHCI_CMD_RESP_LONG | SDHCI_CMD_CRC; break;
    case RESP_R3:
    case RESP_R4:   cmd_para = SDHCI_CMD_RESP_SHORT; break;
    case RESP_R1:
    case RESP_R5:
    case RESP_R6:
    case RESP_R7:   cmd_para = SDHCI_CMD_RESP_SHORT | SDHCI_CMD_CRC | SDHCI_CMD_INDEX; break;
    case RESP_R1b:
    case RESP_R5b:  cmd_para = SDHCI_CMD_RESP_SHORT_BUSY | SDHCI_CMD_CRC | SDHCI_CMD_INDEX; break;
    default:   cmd_para = SDHCI_CMD_RESP_SHORT; break;
  }
