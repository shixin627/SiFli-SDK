...
static void JLINK_DRV_BSP_PIN_Init(void)
{
...
#ifdef JLINK_FLASH_1
    //TODO
    HAL_PIN_Set(PAD_SA09, MPI3_CLK, PIN_NOPULL, 1);            // MPI1
    HAL_PIN_Set(PAD_SA08, MPI3_CS, PIN_NOPULL, 1);
    HAL_PIN_Set(PAD_SA05, MPI3_DIO0, PIN_PULLDOWN, 1);
    HAL_PIN_Set(PAD_SA07, MPI3_DIO1, PIN_PULLDOWN, 1);
    HAL_PIN_Set(PAD_SA06, MPI3_DIO2, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_SA10, MPI3_DIO3, PIN_PULLUP, 1);
#endif
    ...
    HAL_PIN_Set(PAD_PA11, GPIO_A11, PIN_PULLUP, 1); // VDD_EN
...
#else
    // UART3
    HAL_PIN_Set(PAD_PA01, USART3_RXD, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA00, USART3_TXD, PIN_PULLUP, 1);
#endif
