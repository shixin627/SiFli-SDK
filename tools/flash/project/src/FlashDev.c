...
#ifdef JLINK_FLASH_3 // (BSP_QSPI3_MODE == 1)
    64*1024,//0x1000,
#else
...
{
    ALGO_VERSION,              // Algo version
    "SF32LB55X UNI_FLASH",    // Flash device name
    ONCHIP,                    // Flash device type
    ...
    #define FLASH_SIZE  0x02000000
#elif defined(JLINK_FLASH_3)
    #define FLASH_NAME  "SF32LB58X External Flash3"
    #define FLASH_BASE  0x68000000
    #define FLASH_SIZE  0x02000000
#elif defined(JLINK_FLASH_4)
    #define FLASH_NAME  "SF32LB58X External Flash4"
    #define FLASH_BASE  0x12000000
    #define FLASH_SIZE  0x02000000
#endif
...
#ifdef JLINK
#ifdef JLINK_FLASH_1
    #define FLASH_NAME  "SF32LB5XX Internal Flash1"
    #define FLASH_BASE  0x10000000
    #define FLASH_SIZE  0x00200000
#elif defined(JLINK_FLASH_2)
    #define FLASH_NAME  "SF32LB5XX External Flash2"
    #define FLASH_BASE  0x18000000
    #define FLASH_SIZE  0x02000000
#elif defined(JLINK_FLASH_3) // To Be developed.
    #define FLASH_NAME  "SF32LB5XX External Flash3"
    #define FLASH_BASE  0x62000000
    #define FLASH_SIZE  0x02000000
#endif
...
{
    ALGO_VERSION,              // Algo version
    "SF32LB5XX UNI_FLASH",     // Flash device name
    ONCHIP,                    // Flash device type
    0x10000000,                // Flash base address
    0x60000000,                // Total flash device size in Bytes
    // In rtconfig.h, Flash 1 (0x10000000,2M), Flash2(0x18000000, 32M), Flash3(0x62000000,32M)
    0x1000,                    // Affect the FLASH write action. Page Size (number of bytes that will be passed to ProgramPage(). May be multiple of min alignment in order to reduce overhead for calling ProgramPage multiple times
    0,                         // Reserved, should be 0
    0xFF,                      // Flash erased value
    6000,                       // Program page timeout in ms
