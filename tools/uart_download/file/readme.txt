...
PAD_PA33, SD1_DIO7
```
others are same as ram_patch_58x_SD.bin

## ram_patch_58X_TYPE1.bin: 
NOR Flash connected to MPI4 using pins as below,
```
PAD_PA09, MPI4_CLK
PAD_PA10, MPI4_CS
PAD_PA05, MPI4_DIO0
...
others are same as ram_patch_58x.bin

## ram_patch_58X_NAND_TYPE1.bin 
NAND Flash connected to MPI4 using pins as below,
```
PAD_PA09, MPI4_CLK
PAD_PA10, MPI4_CS
PAD_PA05, MPI4_DIO0
...
PAD_PA06, MPI4_DIO3
```
others are same as ram_patch_58x_NAND.bin
