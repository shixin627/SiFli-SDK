...
void rt_hw_set_stack_limit(rt_uint8_t *stack_addr, void *stack_limit);
...
void rt_hw_cfg_pendsv_pri(void);
...
void rt_hw_exception_install_rom(rt_err_t (*exception_handle)(void *context));
