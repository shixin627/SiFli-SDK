...
#define RT_DEBUG_NOT_IN_CRITICAL                                              \
do                                                                            \
{                                                                             \
    rt_base_t level;                                                          \
    level = rt_hw_interrupt_disable();                                        \
    ...
    {                                                                         \
        rt_kprintf("Function[%s] shall not be used in Critical\n", __FUNCTION__);  \
        RT_ASSERT(0)                                                          \
    }                                                                         \
    rt_hw_interrupt_enable(level);                                            \
}                                                                             \
...
#define RT_DEBUG_INTERRUPT_IS_ENABLED                                         \
do                                                                            \
{                                                                             \
    rt_base_t level;                                                          \
    level = rt_hw_interrupt_disable();                                        \
    if (1 == level)                                                           \
    {                                                                         \
        rt_kprintf("Function[%s] shall not be used while interrupt is disabled\n", \
                   __FUNCTION__);                                             \
        RT_ASSERT(0)                                                          \
    }                                                                         \
    rt_hw_interrupt_enable(level);                                            \
