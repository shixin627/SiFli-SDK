...
#define RTT_VERSION                      3L              /**< major version number */
#define RTT_SUBVERSION                   1L              /**< minor version number */
#define RTT_REVISION                     3L              /**< revise version number */
//add for project compile
//#ifdef  BSP_BTS2_PAN
#ifdef RT_USING_LWIP
...
typedef enum
{
    ...
    RT_ERROR_BUS_FAULT,
    RT_ERROR_MEMFAULT,
    RT_ERROR_HW_EXCEPTION,
    RT_ERROR_UNKNOWN_CAUSE
} rt_error_reason_t;
...
#define RT_NO_RETURN                __attribute__((__noreturn__))
...
#define RT_NO_RETURN                __declspec(noreturn)
#define RT_WEAK
#define rt_inline                   static __inline
#define RTT_API
...
#else
#define INIT_EXPORT(fn, level, sublevel)                                                       \
            RT_USED const init_fn_t __rt_init_##fn SECTION(".rti_fn." level sublevel) = fn
#endif
#endif
#else
#define INIT_EXPORT(fn, level)
...
#define STR_CONCAT(a, b, c) STR1_(a##b##c)
/* board init routines will be called in board_init() function */
...
#define RT_TIMER_FLAG_NO_RETENTION      0x0             /**< timer don't need reserve in retention mode. */
#define RT_TIMER_FLAG_RETENTION         0x8             /**< timer need reserve in retention mode. */
...
struct rt_timer
{
    ...
    void (*notify)(struct rt_timer *timer, void *parameter);  /**< wakeup notify function. */
...
#define RT_THREAD_PRIORITY_CRITIAL      (RT_THREAD_PRIORITY_MAX/5)      /**< Soft Timer, 6 */
/**< Main, Finsh, 10 */
#define RT_THREAD_PRIORITY_HIGH         (RT_THREAD_PRIORITY_MAX*2/5)    /**< Device thread, Shell, service, 12*/
#define RT_THREAD_PRIORITY_MIDDLE       (RT_THREAD_PRIORITY_MAX*3/5)    /**< User applications, service 19*/
#define RT_THREAD_PRIORITY_LOW          (RT_THREAD_PRIORITY_MAX*4/5)    /**< LOG, backgroud service, 25 */
#define RT_THREAD_PRIORITY_IDLE         (RT_THREAD_PRIORITY_MAX-1)      /**< IDLE, 31*/

#define RT_THREAD_PRIORITY_DEVICE       RT_THREAD_PRIORITY_HIGH
#define RT_THREAD_PRIORITY_APP          RT_THREAD_PRIORITY_MIDDLE

#define RT_THREAD_PRIORITY_HIGHER       (-1)
#define RT_THREAD_PRIORITY_LOWWER       (1)
...
struct rt_memheap
{
    ...
    rt_uint32_t             actual_used_size;           /**< usered requested size (not including header)  */
    rt_uint32_t             max_actual_used_size;       /**< maximum user requested size (not including header) */
    ...
    struct rt_memheap_item *last_used;                  /**< used block with highest address */
...
enum rt_device_class_type
{
    ...
    RT_Device_Class_Mailbox,                            /**< Mailbox device */
...
#define RT_DEVICE_CTRL_GET_PHY_ADDR         0x14            /**< get physical address  */
...
#define RT_DEVICE_CTRL_RTC_SET_WAKE_TIMER   0x14            /**< set rtc wake time */
#define RT_DEVICE_CTRL_RTC_INC_1S           0x15            /**< Increase/decrease RTC by 1 second */
#define RT_DEVICE_CTRL_RTC_GET_TIMEVAL      0x16            /**< get time, with subseconds */
 ...
 */
struct rt_device_phy_addr_mapping
{
    rt_uint32_t logical_addr;
    rt_uint32_t physical_addr;
};
 ...
 */
#define RTGRAPHIC_CTRL_RECT_UPDATE      (20+0)
#define RTGRAPHIC_CTRL_POWERON          (20+1)
#define RTGRAPHIC_CTRL_POWEROFF         (20+2)
#define RTGRAPHIC_CTRL_GET_INFO         (20+3)
#define RTGRAPHIC_CTRL_SET_MODE         (20+4)
#define RTGRAPHIC_CTRL_GET_EXT          (20+5)
#define RTGRAPHIC_CTRL_SET_BRIGHTNESS   (20+6)
#define RTGRAPHIC_CTRL_SET_BUF_FORMAT   (20+7)
#define RTGRAPHIC_CTRL_GET_BUSY         (20+8)
#define RTGRAPHIC_CTRL_SET_LAYER        (20+9)
#define RTGRAPHIC_CTRL_ROTATE_LAYER     (20+10)
#define RTGRAPHIC_CTRL_SELECT_LAYER     (20+11)
#define RTGRAPHIC_CTRL_ENABLE_LAYER     (20+12)
#define RTGRAPHIC_CTRL_DISABLE_LAYER    (20+13)
#define RTGRAPHIC_CTRL_SET_BG_COLOR     (20+14)
#define RTGRAPHIC_CTRL_GET_STATE        (20+15)
#define RTGRAPHIC_CTRL_SET_NEXT_TE      (20+16)
#define RTGRAPHIC_CTRL_ROTATE_180       (20+17)
#define RTGRAPHIC_CTRL_IRQ_INTERVAL_LINE (20+18)
#define RTGRAPHIC_CTRL_GET_BRIGHTNESS   (20+19)
#define RTGRAPHIC_CTRL_GET_BRIGHTNESS_ASYNC   (20+20)
...
enum
{
    ...
    RTGRAPHIC_PIXEL_FORMAT_A8,
    RTGRAPHIC_PIXEL_FORMAT_L8,
};
...
struct rt_device_graphic_info
{
    ...
    rt_uint8_t  draw_align;                             /**< draw area align requirement in pixel */
    rt_uint8_t  is_round : 1;                               /**< round type or rect type */
    rt_uint8_t  reserved : 7;                               /**< reserved field */

    rt_uint16_t width;                                  /**< width of graphic device */
    rt_uint16_t height;                                 /**< height of graphic device */

    rt_uint8_t *framebuffer;                            /**< frame buffer */
    rt_uint32_t bandwidth;                              /**< bandwidth */
};
...
struct rt_device_graphic_ops
{
    ...
    void (*draw_rect)(const char *pixel, int x0, int y0, int x1, int y1);
    void (*draw_rect_async)(const char *pixel, int x0, int y0, int x1, int y1);

    void (*set_window)(int x0, int y0, int x1, int y1);                   /**< set clip area */
};
