...
__ROM_USED rt_uint8_t rt_current_priority;

#if RT_THREAD_PRIORITY_MAX > 32
    /* Maximum priority level, 256 */
    __ROM_USED rt_uint32_t rt_thread_ready_priority_group;
    __ROM_USED rt_uint8_t rt_thread_ready_table[32];
#else
    /* Maximum priority level, 32 */
    __ROM_USED rt_uint32_t rt_thread_ready_priority_group;
#endif

__ROM_USED rt_list_t rt_thread_defunct;
 ...
 */
__ROM_USED void rt_system_scheduler_init(void)
{
 ...
 */
__ROM_USED void rt_system_scheduler_start(void)
{
 ...
 * with the highest priority level, then switch to it.
 */
__ROM_USED void rt_schedule(void)
{
    rt_base_t level;
 ...
 */
__ROM_USED void rt_schedule_insert_thread(struct rt_thread *thread)
{
 ...
 * @note Please do not invoke this function in user application.
 */
__ROM_USED void rt_schedule_remove_thread(struct rt_thread *thread)
{
    register rt_base_t temp;
 ...
 */
__ROM_USED rt_uint16_t rt_critical_level(void)
{
