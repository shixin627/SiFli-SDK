...
#define EZIP_EZIP_PARA_LAST_Pos         (6U)
#define EZIP_EZIP_PARA_LAST_Msk         (0x1UL << EZIP_EZIP_PARA_LAST_Pos)
#define EZIP_EZIP_PARA_LAST             EZIP_EZIP_PARA_LAST_Msk
...
#define EZIP_GZIP_CTRL_GZIP_CTRL_Msk    (0x1UL << EZIP_GZIP_CTRL_GZIP_CTRL_Pos)
#define EZIP_GZIP_CTRL_GZIP_CTRL        EZIP_GZIP_CTRL_GZIP_CTRL_Msk
