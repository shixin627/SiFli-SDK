...
const lcpu_rom_type_array_t rom_array[] =
{
    ...
    {HAL_LCPU_CONFIG_BLE_FLUSH_CONFIG, LCPU_CONFIG_BLE_FLUSH_CONFIG_OFFSET, HAL_LCPU_CONFIG_BLE_FLUSH_CONFIG_LENGTH},
    {HAL_LCPU_CONFIG_AFH_CONFIG, LCPU_CONFIG_AFH_CONFIG_OFFSET, HAL_LCPU_CONFIG_AFH_CONFIG_LENGTH},
};
