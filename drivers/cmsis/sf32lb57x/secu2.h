...
#define SECU2_LPSLV_ATTR_CFG_SECU2_SEC_Pos  (4U)
#define SECU2_LPSLV_ATTR_CFG_SECU2_SEC_Msk  (0x1UL << SECU2_LPSLV_ATTR_CFG_SECU2_SEC_Pos)
#define SECU2_LPSLV_ATTR_CFG_SECU2_SEC  SECU2_LPSLV_ATTR_CFG_SECU2_SEC_Msk
#define SECU2_LPSLV_ATTR_CFG_SEC2_PRIV_Pos  (5U)
#define SECU2_LPSLV_ATTR_CFG_SEC2_PRIV_Msk  (0x1UL << SECU2_LPSLV_ATTR_CFG_SEC2_PRIV_Pos)
#define SECU2_LPSLV_ATTR_CFG_SEC2_PRIV  SECU2_LPSLV_ATTR_CFG_SEC2_PRIV_Msk
...
/*************** Bit definition for SECU2_APB_ACC_CFG register ****************/
#define SECU2_APB_ACC_CFG_SEC_ATTR_Pos  (0U)
#define SECU2_APB_ACC_CFG_SEC_ATTR_Msk  (0xFFFFUL << SECU2_APB_ACC_CFG_SEC_ATTR_Pos)
#define SECU2_APB_ACC_CFG_SEC_ATTR      SECU2_APB_ACC_CFG_SEC_ATTR_Msk
#define SECU2_APB_ACC_CFG_PRIV_ATTR_Pos  (16U)
#define SECU2_APB_ACC_CFG_PRIV_ATTR_Msk  (0xFFFFUL << SECU2_APB_ACC_CFG_PRIV_ATTR_Pos)
#define SECU2_APB_ACC_CFG_PRIV_ATTR     SECU2_APB_ACC_CFG_PRIV_ATTR_Msk

/*************** Bit definition for SECU2_AHB_ACC_CFG register ****************/
#define SECU2_AHB_ACC_CFG_SEC_ATTR_Pos  (0U)
#define SECU2_AHB_ACC_CFG_SEC_ATTR_Msk  (0xFFFFUL << SECU2_AHB_ACC_CFG_SEC_ATTR_Pos)
#define SECU2_AHB_ACC_CFG_SEC_ATTR      SECU2_AHB_ACC_CFG_SEC_ATTR_Msk
#define SECU2_AHB_ACC_CFG_PRIV_ATTR_Pos  (16U)
#define SECU2_AHB_ACC_CFG_PRIV_ATTR_Msk  (0xFFFFUL << SECU2_AHB_ACC_CFG_PRIV_ATTR_Pos)
#define SECU2_AHB_ACC_CFG_PRIV_ATTR     SECU2_AHB_ACC_CFG_PRIV_ATTR_Msk
