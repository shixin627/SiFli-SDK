...
typedef struct
{
    ...
    __IO uint32_t BUCK1_CR1;
    __IO uint32_t BUCK1_CR2;
...
#define PMUC_BG1_CR_LDOBG_EN_Pos        (11U)
#define PMUC_BG1_CR_LDOBG_EN_Msk        (0x1UL << PMUC_BG1_CR_LDOBG_EN_Pos)
#define PMUC_BG1_CR_LDOBG_EN            PMUC_BG1_CR_LDOBG_EN_Msk
#define PMUC_BG1_CR_BG1_VREF_M_Pos      (16U)
#define PMUC_BG1_CR_BG1_VREF_M_Msk      (0xFUL << PMUC_BG1_CR_BG1_VREF_M_Pos)
#define PMUC_BG1_CR_BG1_VREF_M          PMUC_BG1_CR_BG1_VREF_M_Msk
#define PMUC_BG1_CR_BG1_VREF_L_Pos      (20U)
#define PMUC_BG1_CR_BG1_VREF_L_Msk      (0xFUL << PMUC_BG1_CR_BG1_VREF_L_Pos)
#define PMUC_BG1_CR_BG1_VREF_L          PMUC_BG1_CR_BG1_VREF_L_Msk

/***************** Bit definition for PMUC_BUCK1_CR1 register *****************/
#define PMUC_BUCK1_CR1_BUCK1_EN_Pos     (0U)
#define PMUC_BUCK1_CR1_BUCK1_EN_Msk     (0x1UL << PMUC_BUCK1_CR1_BUCK1_EN_Pos)
#define PMUC_BUCK1_CR1_BUCK1_EN         PMUC_BUCK1_CR1_BUCK1_EN_Msk
#define PMUC_BUCK1_CR1_BUCK1_ILIMIT_Pos  (1U)
#define PMUC_BUCK1_CR1_BUCK1_ILIMIT_Msk  (0x7UL << PMUC_BUCK1_CR1_BUCK1_ILIMIT_Pos)
#define PMUC_BUCK1_CR1_BUCK1_ILIMIT     PMUC_BUCK1_CR1_BUCK1_ILIMIT_Msk
#define PMUC_BUCK1_CR1_BUCK1_CCH_Pos    (4U)
#define PMUC_BUCK1_CR1_BUCK1_CCH_Msk    (0xFUL << PMUC_BUCK1_CR1_BUCK1_CCH_Pos)
#define PMUC_BUCK1_CR1_BUCK1_CCH        PMUC_BUCK1_CR1_BUCK1_CCH_Msk
#define PMUC_BUCK1_CR1_BUCK1_CS_Pos     (8U)
#define PMUC_BUCK1_CR1_BUCK1_CS_Msk     (0xFUL << PMUC_BUCK1_CR1_BUCK1_CS_Pos)
#define PMUC_BUCK1_CR1_BUCK1_CS         PMUC_BUCK1_CR1_BUCK1_CS_Msk
#define PMUC_BUCK1_CR1_BUCK1_SEL_LX22_Pos  (12U)
#define PMUC_BUCK1_CR1_BUCK1_SEL_LX22_Msk  (0x1UL << PMUC_BUCK1_CR1_BUCK1_SEL_LX22_Pos)
#define PMUC_BUCK1_CR1_BUCK1_SEL_LX22   PMUC_BUCK1_CR1_BUCK1_SEL_LX22_Msk
#define PMUC_BUCK1_CR1_BUCK1_MOT_Pos    (13U)
#define PMUC_BUCK1_CR1_BUCK1_MOT_Msk    (0x7UL << PMUC_BUCK1_CR1_BUCK1_MOT_Pos)
#define PMUC_BUCK1_CR1_BUCK1_MOT        PMUC_BUCK1_CR1_BUCK1_MOT_Msk
#define PMUC_BUCK1_CR1_BUCK1_BM_COTCMP_Pos  (16U)
#define PMUC_BUCK1_CR1_BUCK1_BM_COTCMP_Msk  (0x7UL << PMUC_BUCK1_CR1_BUCK1_BM_COTCMP_Pos)
#define PMUC_BUCK1_CR1_BUCK1_BM_COTCMP  PMUC_BUCK1_CR1_BUCK1_BM_COTCMP_Msk
#define PMUC_BUCK1_CR1_BUCK1_BM_PWMCMP_Pos  (19U)
#define PMUC_BUCK1_CR1_BUCK1_BM_PWMCMP_Msk  (0x7UL << PMUC_BUCK1_CR1_BUCK1_BM_PWMCMP_Pos)
#define PMUC_BUCK1_CR1_BUCK1_BM_PWMCMP  PMUC_BUCK1_CR1_BUCK1_BM_PWMCMP_Msk
#define PMUC_BUCK1_CR1_BUCK1_BM_ZCD_Pos  (22U)
#define PMUC_BUCK1_CR1_BUCK1_BM_ZCD_Msk  (0x7UL << PMUC_BUCK1_CR1_BUCK1_BM_ZCD_Pos)
#define PMUC_BUCK1_CR1_BUCK1_BM_ZCD     PMUC_BUCK1_CR1_BUCK1_BM_ZCD_Msk
#define PMUC_BUCK1_CR1_BUCK1_ZCD_AON_Pos  (25U)
#define PMUC_BUCK1_CR1_BUCK1_ZCD_AON_Msk  (0x1UL << PMUC_BUCK1_CR1_BUCK1_ZCD_AON_Pos)
#define PMUC_BUCK1_CR1_BUCK1_ZCD_AON    PMUC_BUCK1_CR1_BUCK1_ZCD_AON_Msk
#define PMUC_BUCK1_CR1_BUCK1_RDY_Pos    (26U)
#define PMUC_BUCK1_CR1_BUCK1_RDY_Msk    (0x1UL << PMUC_BUCK1_CR1_BUCK1_RDY_Pos)
#define PMUC_BUCK1_CR1_BUCK1_RDY        PMUC_BUCK1_CR1_BUCK1_RDY_Msk
#define PMUC_BUCK1_CR1_BUCK1_L2M_EN_Pos  (27U)
#define PMUC_BUCK1_CR1_BUCK1_L2M_EN_Msk  (0x1UL << PMUC_BUCK1_CR1_BUCK1_L2M_EN_Pos)
#define PMUC_BUCK1_CR1_BUCK1_L2M_EN     PMUC_BUCK1_CR1_BUCK1_L2M_EN_Msk
#define PMUC_BUCK1_CR1_BUCK1_M2L_EN_Pos  (28U)
#define PMUC_BUCK1_CR1_BUCK1_M2L_EN_Msk  (0x1UL << PMUC_BUCK1_CR1_BUCK1_M2L_EN_Pos)
#define PMUC_BUCK1_CR1_BUCK1_M2L_EN     PMUC_BUCK1_CR1_BUCK1_M2L_EN_Msk
#define PMUC_BUCK1_CR1_BUCK1_H2L_EN_Pos  (29U)
#define PMUC_BUCK1_CR1_BUCK1_H2L_EN_Msk  (0x1UL << PMUC_BUCK1_CR1_BUCK1_H2L_EN_Pos)
#define PMUC_BUCK1_CR1_BUCK1_H2L_EN     PMUC_BUCK1_CR1_BUCK1_H2L_EN_Msk
#define PMUC_BUCK1_CR1_BUCK1_H2M_EN_Pos  (30U)
#define PMUC_BUCK1_CR1_BUCK1_H2M_EN_Msk  (0x1UL << PMUC_BUCK1_CR1_BUCK1_H2M_EN_Pos)
#define PMUC_BUCK1_CR1_BUCK1_H2M_EN     PMUC_BUCK1_CR1_BUCK1_H2M_EN_Msk
#define PMUC_BUCK1_CR1_BUCK1_FORCE_RDY_Pos  (31U)
#define PMUC_BUCK1_CR1_BUCK1_FORCE_RDY_Msk  (0x1UL << PMUC_BUCK1_CR1_BUCK1_FORCE_RDY_Pos)
#define PMUC_BUCK1_CR1_BUCK1_FORCE_RDY  PMUC_BUCK1_CR1_BUCK1_FORCE_RDY_Msk

/***************** Bit definition for PMUC_BUCK1_CR2 register *****************/
#define PMUC_BUCK1_CR2_M2H_CNT_Pos      (0U)
#define PMUC_BUCK1_CR2_M2H_CNT_Msk      (0xFFUL << PMUC_BUCK1_CR2_M2H_CNT_Pos)
#define PMUC_BUCK1_CR2_M2H_CNT          PMUC_BUCK1_CR2_M2H_CNT_Msk
#define PMUC_BUCK1_CR2_L2H_CNT_Pos      (8U)
#define PMUC_BUCK1_CR2_L2H_CNT_Msk      (0xFFUL << PMUC_BUCK1_CR2_L2H_CNT_Pos)
#define PMUC_BUCK1_CR2_L2H_CNT          PMUC_BUCK1_CR2_L2H_CNT_Msk
#define PMUC_BUCK1_CR2_L2M_CNT_Pos      (16U)
#define PMUC_BUCK1_CR2_L2M_CNT_Msk      (0xFFUL << PMUC_BUCK1_CR2_L2M_CNT_Pos)
#define PMUC_BUCK1_CR2_L2M_CNT          PMUC_BUCK1_CR2_L2M_CNT_Msk
