                          ...
                          AVPacket *avpkt)
{
    ...
    if(s->first_picture)
    {
        ...
        //avctx->pix_fmt = AV_PIX_FMT_RGB565LE;  Use user defined output format
    ...
    {
        case AV_PIX_FMT_RGB565LE: decode_format = "RGB565"; break;
        case AV_PIX_FMT_ARGB: decode_format = "ARGB8888"; break;
