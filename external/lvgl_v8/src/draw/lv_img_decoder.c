                                                   ...
                                                   lv_coord_t len, uint8_t * buf)
{
    ...
    for(i = 0; i < len; i++) {
        ...
        buf[i * LV_IMG_PX_SIZE_ALPHA_BYTE] = bg_color.ch.blue;
        buf[i * LV_IMG_PX_SIZE_ALPHA_BYTE + 1] = bg_color.ch.green;
        buf[i * LV_IMG_PX_SIZE_ALPHA_BYTE + 2] = bg_color.ch.red;        
...
#elif LV_COLOR_DEPTH == 24
        buf[i * LV_IMG_PX_SIZE_ALPHA_BYTE] = color.ch.blue;
        buf[i * LV_IMG_PX_SIZE_ALPHA_BYTE + 1] = color.ch.green;
        buf[i * LV_IMG_PX_SIZE_ALPHA_BYTE + 2] = color.ch.red;        
#elif LV_COLOR_DEPTH == 32
