...
#elif LV_USE_GPU_SIFLI_EPIC
    driver->draw_ctx_init   = lv_gpu_epic_ctx_init;
    driver->draw_ctx_deinit = lv_gpu_epic_ctx_deinit;
    driver->draw_ctx_size   = sizeof(epic_draw_ctx_t);
#else
...
void set_px_true_color_alpha(lv_disp_drv_t * disp_drv, uint8_t * buf, lv_coord_t buf_w,
