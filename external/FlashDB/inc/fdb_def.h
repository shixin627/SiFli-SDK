...
//TODO: same as sector number
#ifndef FDB_SECTOR_HDR_CACHE_TABLE_SIZE
#define FDB_SECTOR_HDR_CACHE_TABLE_SIZE (256)
#endif
...
struct sector_hdr_cache_node {
    uint32_t addr;
    uint32_t combined;
    fdb_sector_store_status_t store;
    fdb_sector_dirty_status_t dirty;
};

typedef struct sector_hdr_cache_node *sector_hdr_cache_node_t;
