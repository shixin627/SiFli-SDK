...
{ \
    ...
    {FAL_PART_MAGIC_WORD,       "coredump_min",      NOR_FLASH2_DEV_NAME,    COREDUMP_MIN_REGION_OFFSET,   COREDUMP_MIN_REGION_SIZE, 0}, \
    {FAL_PART_MAGIC_WORD,       "coredump",      NOR_FLASH2_DEV_NAME,    COREDUMP_REGION_OFFSET,   COREDUMP_REGION_SIZE, 0}, \
}
