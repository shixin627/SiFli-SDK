...
/* ================= HID Configuration ================= */
#ifndef CONFIG_USBDEV_HID_MAX_BUFSIZE
    #define CONFIG_USBDEV_HID_MAX_BUFSIZE 64
#endif

/* move hid read & write from isr to thread */
// #define CONFIG_USBDEV_HID_THREAD

#ifndef CONFIG_USBDEV_HID_PRIO
    #define CONFIG_USBDEV_HID_PRIO 4
#endif

#ifndef CONFIG_USBDEV_HID_STACKSIZE
    #define CONFIG_USBDEV_HID_STACKSIZE 2048
#endif

/* ================= CDC ACM Configuration ================= */
#ifndef CONFIG_USBDEV_CDC_MAX_BUFSIZE
    #define CONFIG_USBDEV_CDC_MAX_BUFSIZE 2048
#endif

/* move cdc acm read & write from isr to thread */
// #define CONFIG_USBDEV_CDC_THREAD

#ifndef CONFIG_USBDEV_CDC_PRIO
    #define CONFIG_USBDEV_CDC_PRIO 4
#endif

#ifndef CONFIG_USBDEV_CDC_STACKSIZE
    #define CONFIG_USBDEV_CDC_STACKSIZE 2048
#endif
...
/* Because lwip do not support multi pbuf at a time, so increasing this variable has no performance improvement */
    ...
    #define CONFIG_USBDEV_CDC_NCM_ETH_MAX_TX_SIZE (2048)
#endif
