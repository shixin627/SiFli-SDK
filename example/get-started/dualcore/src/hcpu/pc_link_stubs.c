...
/* communicate_task.h */ bool commu_send_battery_snapshot(void) { return false; }
...
bool mouse_wrist_accum_triggered(void) { return false; }
...
/* communicate_task.h */ bool commu_send_conv_avatar_req(const char *av) { (void)av; return false; }
