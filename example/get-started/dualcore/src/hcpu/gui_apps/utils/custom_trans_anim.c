...
static void enter_or_exit_anim0(gui_anim_obj_t img, void *user_data, uint32_t flag, gui_anim_value_t process)
{
    ...
    if ((0 == (flag & (FLAG_TRANS_ANIM_FG | FLAG_TRANS_ANIM_REVERSE))) || ((FLAG_TRANS_ANIM_FG | FLAG_TRANS_ANIM_REVERSE) == (flag & (FLAG_TRANS_ANIM_FG | FLAG_TRANS_ANIM_REVERSE))))
    {
    ...
    else if (code == LV_EVENT_DRAW_MAIN)
    {
...
#endif /* SF32LB55X */
        {
            ...
            img_rotate_opa_frac2(&dest, p_src_img, 0, pitch_x, EPIC_INPUT_SCALE_NONE,
                                 ...
                                 draw_ctx->clip_area, &tmp_pivot, LV_OPA_COVER, LV_COLOR_CHROMA_KEY,
                                 0, 0, 1,
                                 0, NULL, NULL);
        }
        e->stop_processing = 1;
