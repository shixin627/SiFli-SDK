...
#define HCPU_CODE_MAX_SIZE (0x00400000) // 4MB
#define HCPU_CODE_START_ADDRESS 0x64000000 // HCPU_FLASH_CODE_START_ADDR
...
#define FTAB_START_ADDRESS 0x1C000000 // FTAB_FLASH_CODE_START_ADDR
...
#define BOOTLOADER_START_ADDRESS 0x1C020000 // BOOTLOADER_FLASH_START_ADDR
