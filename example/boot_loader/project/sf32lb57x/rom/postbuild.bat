...
copy build\bootloader.axf %bin_path%\bootloader_57x.axf /y
copy build\bootloader.bin %bin_path%\bootloader_57x.bin /y
copy build\bootloader.hex %bin_path%\bootloader_57x.hex /y