...
static rt_uint16_t get_active_tile_col(lv_obj_t *tileview)
{
    ...
    lv_obj_t *active_tile = tv->tile_act; // ��ȡ��ǰ��Ծ�� tile ����
    ...
    int32_t w = lv_obj_get_content_width(tileview); // ��ȡ Tileview ���� tile �Ŀ���
    int32_t x = lv_obj_get_x(active_tile); // ��ȡ��ǰ��Ծ tile �� X ����
