# BT a2dp multi-connection示例

源码路径：example/bt/a2dp_multi_connect
...
## 概述
<!-- 例程简介 -->
本例程演示与手机等A2DP Source设备进行多个a2dp连接，并在本机播放source设备的音乐，如果有2个设备同时播放则会做混音处理。
...
8. 使能aac解码器
![AAC](./assets/mc_enable_aac.png)
9. 使能混音功能
![AUDIO MIX](./assets/mc_audio_mix.png)
10. 使能A2DP多连接功能
![A2DP MULTI](./assets/mc_a2dp_multi.png)


### 编译和烧录
切换到例程project目录，运行scons命令执行编译，例如board为eh-lb525：
```c
...
please input the serial port num:5，(需要输入板子的串口号，比如5)
```
